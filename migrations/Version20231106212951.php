 ...
 */
final class Version20231106212951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job_id INT DEFAULT NULL, CHANGE job profile VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP job_id, CHANGE profile job VARCHAR(50) DEFAULT NULL');
    }
}
